...
* **Pengelompokan / Prediksi**: Membangun model analitik (seperti clustering/klasifikasi) guna mengelompokkan fase atau tingkat keparahan polutan sebagai acuan mitigasi lingkungan.
...
* **Akademisi & Peneliti**: Menjadi modul studi empiris penerapan pemrosesan sinyal digital (PSD) dan sains data pada domain pemantauan lingkungan (*remote sensing*).